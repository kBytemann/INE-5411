...
#######		contagem sem erro		######
######################################################							
							#	Resultado esperado	R=7(out of bounds)														#	i = $s3
							#	k = $s5 = 6
							#	address base do arranjo = $s6
.data
_save: 	.word	9999,7,6,6,6,6,6,6,6			#	elementos do arranjo, 2 valor == tamanho do array
...
loop:		beq	$s3, $t2, indexout		# teste para ver se o contador já não ultrapassou o tamanho do array
